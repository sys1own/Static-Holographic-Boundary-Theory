...
_BOOTSTRAP_PARENT_LEVEL = _coerce_int(_MODEL_CONFIG, "parent_level")
_BOOTSTRAP_LEPTON_FIXED_POINT_INDEX = _coerce_int(_MODEL_CONFIG, "lepton_fixed_point_index")
_BOOTSTRAP_QUARK_FIXED_POINT_INDEX = _coerce_int(_MODEL_CONFIG, "quark_fixed_point_index")
...
BOOTSTRAP_STABLE_EIGENVALUE = ZERO_ANCHOR_BOOTSTRAP.stable_eigenvalue
BOOTSTRAP_LABELED_RESIDUES = ZERO_ANCHOR_BOOTSTRAP.labeled_residues
_BOOTSTRAP_EMERGENT_CONSTANTS = ZERO_ANCHOR_BOOTSTRAP.emergent_constants
...
HOLOGRAPHIC_NOISE_FLOOR = Decimal("1e-15")
...
G_SM = _BOOTSTRAP_GENERATION_COUNT
...
BENCHMARK_MANIFEST_FILENAME: str = "benchmark.yaml"
